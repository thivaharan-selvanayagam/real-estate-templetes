...
export default function ContactPage() {
  ...
  return (
    <div className="bg-[#F8F7F4] min-h-screen">
      ...
      {/* 1. DEEP NAVY HEADER AREA */}
      <section className="bg-navy relative pt-32 pb-32 lg:pt-40 lg:pb-40 overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-20 -mt-20 lg:-mt-24 pb-24">
        ...
        <div className="flex flex-col lg:flex-row bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-100">
          ...
          {/* LEFT SIDE: Deep Navy Credentials Panel */}
          <div className="w-full lg:w-5/12 bg-navy text-white p-10 lg:p-14 relative overflow-hidden flex flex-col justify-between">
            ...
            {submitted ? (
              <div className="bg-[#F8F7F4] border border-gray-100 rounded-2xl p-10 text-center mx-auto w-full animate-fade-in">
                ...
                <button 
                  ...
                  className="bg-navy text-white text-xs font-bold tracking-widest uppercase px-8 py-3 rounded-full hover:bg-gold transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="w-full flex flex-col gap-8">
                <div>
                  <h2 className="font-display text-2xl lg:text-3xl font-bold text-navy uppercase tracking-wide mb-2">
                    Direct Inquiry
                  </h2>
                ...
                <div className="flex flex-col gap-6">
                  <div className="relative">
                    <input 
                      ...
                      className="peer w-full bg-transparent border-b-2 border-gray-200 py-3 text-sm text-navy outline-none focus:border-navy transition-colors placeholder-shown:border-gray-200"
                    />
                    <label className="absolute left-0 top-3 text-xs uppercase font-bold tracking-widest text-gray-400 pointer-events-none transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-focus:-top-5 peer-focus:text-[10px] peer-focus:text-navy -top-5 text-[10px]">
                      Full Name *
                    </label>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
                    <div className="relative">
                      ...
                      />
                      <label className="absolute left-0 top-3 text-xs uppercase font-bold tracking-widest text-gray-400 pointer-events-none transition-all peer-focus:-top-5 peer-focus:text-[10px] peer-focus:text-navy -top-5 text-[10px]">
                        Email Address *
                      </label>
                    </div>
                  ...
                  <div className="relative mt-6">
                    <textarea 
                      ...
                      className="peer w-full bg-transparent border-b-2 border-gray-200 py-3 text-sm text-navy outline-none focus:border-navy transition-colors resize-none"
                    />
                    <label className="absolute left-0 top-3 text-xs uppercase font-bold tracking-widest text-gray-400 pointer-events-none transition-all peer-focus:-top-5 peer-focus:text-[10px] peer-focus:text-navy -top-5 text-[10px]">
                      How Can I Help You? *
                    </label>
                ...
                <button 
                  type="submit" 
                  className="bg-gold text-white text-xs font-bold tracking-widest uppercase px-10 py-4 rounded-full hover:bg-navy transition-colors self-start mt-4 shadow-md hover:shadow-lg"
                >
                  Submit Inquiry
                </button>
              </form>
